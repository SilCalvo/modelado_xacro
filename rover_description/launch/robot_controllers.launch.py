...
def generate_launch_description():
        ...
        [
            generate_load_controller_launch_description(
                ...
                controller_params_file=join(
                    pkg_share_folder, 'config', 'config.yaml'))
        ],
    )
    ...
    arm_pkg_share_folder = get_package_share_directory('rover_model_moveit_config') #rover_model_moveit_config
    # Load arm controller
    arm_controller = GroupAction(
        [
            generate_load_controller_launch_description(
                ...
                controller_params_file=join(
                    arm_pkg_share_folder, 'config', 'ros2_controllers.yaml') #ros2_controllers
        )
        ],
    )
