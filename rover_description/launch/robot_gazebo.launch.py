...
def generate_launch_description():
    moveit_config = MoveItConfigsBuilder("rover", package_name="rover_model_moveit_config").to_moveit_configs()
    ...
    robot_description_launcher = IncludeLaunchDescription(
       PathJoinSubstitution(
           ...
           [FindPackageShare("rover_model_moveit_config"), "launch", "rsp.launch.py"]
       ),
    )
